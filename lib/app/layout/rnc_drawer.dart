...
class PermissionExpansionItem {
  final String title;
  final int permission;
  bool isExpanded = true;
  late ExpansionPanel expansionPanel;

  PermissionExpansionItem.build(
    this.title,
    this.permission,
    IconData titleIcon,
    List<PermissionExpansionItemChild> childrenTitle,
  ) {
...
class PermissionExpansionItemChild {
  final String title;
  final IconData icon;

  PermissionExpansionItemChild(this.title, this.icon);
}
